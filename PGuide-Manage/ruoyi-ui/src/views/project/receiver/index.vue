    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['project:receiver:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['project:receiver:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['project:receiver:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['project:receiver:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listReceiver, getReceiver, delReceiver, addReceiver, updateReceiver } from "@/api/project/receiver";
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getReceiver(taskId).then(response => {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('project/receiver/export', {
        ...this.queryParams

<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="开放级别" prop="projectOpenLevel">
        <el-input
          v-model="queryParams.projectOpenLevel"
          placeholder="请输入开放级别"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="projectinfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="学科" align="center" prop="projectSubjectType" />
      <el-table-column label="开放级别" align="center" prop="projectOpenLevel" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="开放级别" prop="projectOpenLevel">
          <el-input v-model="form.projectOpenLevel" placeholder="请输入开放级别" />
        </el-form-item>
        <el-form-item label="注册时间" prop="created">
          <el-date-picker clearable
...
<script>
import { listProjectinfo, getProjectinfo, delProjectinfo, addProjectinfo, updateProjectinfo } from "@/api/manage/projectinfo";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除项目信息主表编号为"' + projectIds + '"的数据项？').then(function() {
